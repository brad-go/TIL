...
- [브릿지](https://www.notion.so/Bridge-Pattern-f903402a355b40848c3ea44a5f00075c), 상태, 전략(및 [어댑터 패턴](../Adapter/))은 매우 유사한 구조를 가지고 있습니다. 실제로 이러한 모든 패턴은 작업을 다른 객체에 위임하는 구성을 기반으로 합니다. 그러나 그들은 모두 다른 문제를 해결합니다.
